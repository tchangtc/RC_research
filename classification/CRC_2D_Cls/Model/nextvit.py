...
# pretrain_dir = '/home/data/pretrained/nextvit_base_in1k6m_384.pth'
pretrain_dir = '/home/workspace/pretrained/nextvit_base_in1k6m_384.pth'
class next_vit_base(NextViT):
    def __init__(self, **kwargs):
        super(next_vit_base, self).__init__(
            stem_chs=[64, 32, 64], 
            depths=[3, 4, 20, 3], 
            path_dropout=0.2, 
